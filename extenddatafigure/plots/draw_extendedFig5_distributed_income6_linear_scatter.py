...
KIND = "distributed"
FIGURE_BASENAME = "extendedFig5-distributed-income6-irradiance-percapita-linear-scatter"
...
LABEL_OFFSETS = {
    "CHINA": (-12, 8, "right", "bottom"),
    "UNITED STATES": (16, -18, "left", "top"),
    "JAPAN": (-10, 10, "right", "bottom"),
    "GERMANY": (28, 24, "left", "bottom"),
    "AUSTRALIA": (-10, 9, "right", "bottom"),
    "MALTA": (7, 7, "left", "bottom"),
    "LEBANON": (7, 7, "left", "bottom"),
    "ITALY": (7, 7, "left", "bottom"),
    "NETHERLANDS": (-24, 24, "right", "bottom"),
    "SINGAPORE": (18, 18, "left", "bottom"),
    "BELGIUM": (20, 8, "left", "bottom"),
    "SWITZERLAND": (-10, -11, "right", "top"),
    "AUSTRIA": (24, -13, "left", "top"),
    "SLOVENIA": (12, 10, "left", "bottom"),
    "PORTUGAL": (-28, -20, "right", "top"),
    "SPAIN": (18, 14, "left", "bottom"),
    "JORDAN": (7, 7, "left", "bottom"),
    "BRAZIL": (9, 9, "left", "bottom"),
    "INDIA": (-18, 15, "right", "bottom"),
    "SOUTH AFRICA": (7, 7, "left", "bottom"),
    "FRANCE": (-10, -10, "right", "top"),
}
...
def draw_income6_linear_scatter() -> None:
    ...
    fig.subplots_adjust(left=0.095, right=0.78, top=0.92, bottom=0.16)
